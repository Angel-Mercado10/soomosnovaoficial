-- ============================================================
-- SoomosNova v1.0 — Schema completo
-- Ejecutar en: Supabase Dashboard → SQL Editor → New query
-- Orden: este archivo primero, luego rls_policies.sql
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_confirmaciones_evento_id  ON confirmaciones(evento_id);
CREATE INDEX IF NOT EXISTS idx_ingresos_evento_id        ON ingresos(evento_id);
CREATE INDEX IF NOT EXISTS idx_fotos_evento_id           ON fotos(evento_id);
CREATE INDEX IF NOT EXISTS idx_dedicatorias_evento_id    ON dedicatorias(evento_id);
...
DROP TRIGGER IF EXISTS trigger_set_album_expira ON eventos;
